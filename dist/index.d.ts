...
declare const createInscribeTx: ({ senderMnemonic, senderAddress, utxos, inscriptions, feeRatePerByte, data, sequence, isSelectUTXOs, isTestNet, }: {
